...
public class ChunkGeneratorFrozenEnd implements IChunkGenerator
{
    /** RNG. */
    ...
    public ChunkGeneratorFrozenEnd(World world, boolean mapFeaturesEnabled, long seed, BlockPos spawnPoint) {
        endCityGen  = new MapGenEndCity(new ChunkGeneratorEnd(world, mapFeaturesEnabled, seed, spawnPoint));
        this.world = world;
        ...
        /* A NoiseGeneratorOctaves used in generating terrain */ /** A NoiseGeneratorOctaves used in generating terrain */
        NoiseGeneratorOctaves noiseGen6 = new NoiseGeneratorOctaves(this.rand, 16);
    ...
    public void populate(int x, int z)
    {
        ...
        if (TerrainGen.populate(this, this.world, this.rand, x, z, true, PopulateChunkEvent.Populate.EventType.ICE)) {
