...
abstract class WorldGenDeadHugeTrees extends WorldGenAbstractTree {
    /** The base height of the tree */
    private final int baseHeight;
    /** Sets the metadata for the wood blocks used */
    final IBlockState woodMetadata;
    private final int extraRandomHeight;

    WorldGenDeadHugeTrees(boolean notify, int baseHeightIn, int extraRandomHeightIn, IBlockState woodMetadataIn, IBlockState leavesMetadataIn)
    {
        super(notify);
        this.baseHeight = baseHeightIn;
        this.extraRandomHeight = extraRandomHeightIn;
        this.woodMetadata = woodMetadataIn;
        /* Sets the metadata for the leaves used in huge trees */ /** Sets the metadata for the leaves used in huge trees */
        IBlockState leavesMetadata = leavesMetadataIn;
    }

    /**
     * calculates the height based on this trees base height and its extra random height
     */
    int getHeight(Random rand)
    {
     ...
     */
    boolean ensureGrowable(World worldIn, Random rand, BlockPos treePos, int height)
    {
     ...
     */
    void growLeavesLayerStrict(World worldIn, BlockPos layerCenter, int width)
    {
        int i = width * width;
     ...
     */
    void growLeavesLayer(World worldIn, BlockPos layerCenter, int width)
    {
        int i = width * width;
