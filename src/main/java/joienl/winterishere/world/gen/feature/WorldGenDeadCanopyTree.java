...
public class WorldGenDeadCanopyTree extends WorldGenAbstractTree
{
    ...
    private static final IBlockState DARK_OAK_LEAVES = Blocks.AIR.getDefaultState();

    public WorldGenDeadCanopyTree(boolean notify)
    {
        super(notify);
    }
