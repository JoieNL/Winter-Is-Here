...
public class WorldGenDeadMegaJungleTree extends WorldGenDeadHugeTrees {
    public WorldGenDeadMegaJungleTree(boolean notify, int baseHeightIn, int extraRandomHeightIn, IBlockState woodMetadataIn, IBlockState leavesMetaDataIn)
    {
