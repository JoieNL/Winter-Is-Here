...
class BiomeFrozenMesa extends BiomeFrozen {
    ...
    private static final IBlockState HARDENED_CLAY = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.LIGHT_BLUE);
    private static final IBlockState ORANGE_STAINED_HARDENED_CLAY = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.CYAN);
    private static final IBlockState RED_SAND = ModBlocks.BLUE_SAND.getDefaultState();
    ...
    BiomeFrozenMesa(boolean brycePillars, boolean hasForest, Biome.BiomeProperties properties) {
        super(properties);
     ...
     */
    @Override
    public BiomeDecorator createBiomeDecorator() { return new BiomeFrozenMesa.Decorator(); }

    @Override
    public WorldGenAbstractTree getRandomTreeFeature(Random rand) { return TREE_FEATURE; }
                ...
                if (iblockstate1.getMaterial() == Material.AIR) {
                    ...
                    if (l == -1) {
                            ...
                            if (this.hasForest && j1 > 86 + k * 2) {
                                ...
                                if (j1 >= 64 && j1 <= 127) {
                                    if (flag) {
                                        ...
                                        iblockstate2 = this.getBand(x, j1);
                                    }
                                }
                                else {
                        ...
                        if (flag1) {
                            ...
                            chunkPrimerIn.setBlockState(l1, j1, k1, this.getBand(x, j1));
                        }
                    }
    ...
    private void generateBands(long p_150619_1_) {
        ...
        for (int i = 0; i < i2; ++i) {
            ...
            for (int l = 0; k + l < 64 && l < j; ++l) {
                this.clayBands[k + l] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.BLUE);
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2) {
            ...
            for (int i1 = 0; l3 + i1 < 64 && i1 < i3; ++i1) {
                this.clayBands[l3 + i1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.BLUE);
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3) {
            ...
            for (int j1 = 0; k4 + j1 < 64 && j1 < i4; ++j1) {
                this.clayBands[k4 + j1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.CYAN);
            }
        }
    ...
    private IBlockState getBand(int p_180629_1_, int p_180629_2_) {
    ...
    public int getFoliageColorAtPos(BlockPos pos) { return 10387789; }

    @Override
    @SideOnly(Side.CLIENT)
    public int getGrassColorAtPos(BlockPos pos) { return 9470285; }
