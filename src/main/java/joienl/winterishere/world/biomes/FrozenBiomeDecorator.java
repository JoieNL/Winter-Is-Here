...
public class FrozenBiomeDecorator {
    ...
    public int waterlilyPerChunk = -999;
     ...
     */
    public int flowersPerChunk = -999;
    /** The amount of tall grass to generate per chunk. */
    public int grassPerChunk = -999;
    /** The number of dead bushes to generate per chunk. Used in deserts and swamps. */
    public int deadBushPerChunk = -999;
    /**
     * The number of extra mushroom patches per chunk. It generates 1/4 this number in brown mushroom patches, and 1/8
     * this number in red mushroom patches. These mushrooms go beyond the default base number of mushrooms.
     */
    public int mushroomsPerChunk = -999;
    /** The number of reeds to generate per chunk. Reeds won't generate if the randomly selected placement is unsuitable. */
    public int reedsPerChunk = -999;
    /** The number of cactus plants to generate per chunk. Cacti only work on sand. */
    public int cactiPerChunk = -999;
    ...
    public int bigMushroomsPerChunk = -999;
        ...
        if (this.generateFalls)
        {
            if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, random, chunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.LAKE_WATER))
                for (int k5 = 0; k5 < 50; ++k5)
                {
                    ...
                    if (i17 > 0)
                    {
                        ...
                        (new WorldGenLiquids(Blocks.PACKED_ICE)).generate(worldIn, random, blockpos6);
                    }
                }
            ...
            if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, random, chunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.LAKE_LAVA))
                for (int l5 = 0; l5 < 20; ++l5)
                {
                    ...
                    (new WorldGenLiquids(Blocks.OBSIDIAN)).generate(worldIn, random, blockpos3);
                }
        }
