...
public class EntityIceCube extends EntitySlime {
    public EntityIceCube(World worldIn) { super(worldIn); }
    ...
    @Override
    public boolean getCanSpawnHere() { return this.world.getDifficulty() != EnumDifficulty.PEACEFUL; }
    ...
    @Override
    protected EnumParticleTypes getParticleType() { return EnumParticleTypes.SNOW_SHOVEL; }

    @Override
    protected EntitySlime createInstance() { return new EntityIceCube(this.world); }

    @Override
    @Nullable
    protected ResourceLocation getLootTable() {
        return this.isSmallSlime() ? LootTableList.EMPTY : ModLootTables.ICE_CUBE;
    }

    @Override
    protected int getJumpDelay() { return super.getJumpDelay() * 4; }

    @Override
    protected void alterSquishAmount() { this.squishAmount *= 0.9F; }
    ...
    @Override
    protected int getAttackStrength() { return super.getAttackStrength() + 2; }
