...
public abstract class EntityIceball extends Entity {
    ...
    private EnumParticleTypes getParticleType() { return EnumParticleTypes.SNOW_SHOVEL; }

    /**
     * Return the motion factor for this projectile. The factor is multiplied by the original motion.
     */
    private float getMotionFactor() { return 0.95F; }
    ...
    @Override
    public float getCollisionBorderSize() { return 1.0F; }
